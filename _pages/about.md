...
Beyond my academic pursuits, I co-founded <span style="background: linear-gradient(90deg, #ff4fd8, #3b82f6); -webkit-background-clip: text; background-clip: text; color: transparent; font-weight: 800;"> Eternl.AI</span>, where I architect AI infrastructure that enables embodied intelligence in interactive gaming environments. My technical contributions span several interconnected domains: I develop **agentic systems** that integrate large language models with reinforcement learning frameworks to produce contextually-aware NPCs with personality-driven decision-making and goal-oriented combat strategies. I design **personalization architectures** using Retrieval-Augmented Generation (RAG) and parameter-efficient fine-tuning (PEFT) methods to ensure character consistency and narrative coherence across extended interactions. To address the generalization challenges inherent in value-based policy learning, I advance **transfer learning** methodologies that leverage multimodal language model grounding to improve agent adaptability across heterogeneous game mechanics and environmental dynamics. Additionally, I build **generative pipelines for dynamic 3D synthesis**, enabling procedurally evolving game worlds that respond to player actions. This work demonstrates how research in embodied reasoning, spatial language understanding, and structured generation can be operationalized into production-scale systems that fundamentally transform interactive entertainment.
